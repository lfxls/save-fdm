...
<script type="text/javascript" src="${ctx}/js/modules/reportModule/insInfoReport/woStsRep/woStsRep.js"> </script>
</head>
<body class="body">
...
<div class="ui-panel">
	<div class="ui-panel-body" style="padding:10px">
		...
		<tr>
			<td width="10%" align="right">
				<label class="ui-label">
						<s:text name="report.insInfoReport.woStsRep.team"></s:text>
				</label>
			</td>
			<td width="13%">
		...
		<tr>
			<td width="10%" align="right">
				<label class="ui-label">
						<s:text name="report.insInfoReport.woStsRep.status"></s:text>
				</label>
			</td>
			<td width="13%">
		...
		<tr>
			<td  width="10%" align="right">
			<label class="ui-label">
						<s:text name="report.insInfoReport.woStsRep.delayDate"></s:text>
				</label>
			</td>
			<td width="13%">
