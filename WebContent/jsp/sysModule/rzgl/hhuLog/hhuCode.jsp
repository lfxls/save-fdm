...
<script type="text/javascript" src="${ctx}/js/modules/sysModule/rzgl/hhuLog/hhuCode.js"></script>
</head>
<body class="body">
<s:hidden id="logId" name="logId"/>
<form id="hhuCodeForm" name="hhuCodeForm" onsubmit="return false;" class="ui-form">
	<div class="ui-tab">
