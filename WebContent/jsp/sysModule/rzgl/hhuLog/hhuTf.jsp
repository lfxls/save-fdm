...
<script type="text/javascript" src="${ctx}/js/modules/sysModule/rzgl/hhuLog/hhuTf.js"></script>
</head>
<body class="body">
<s:hidden id="logId" name="logId"/>
<form id="hhuTfForm" name="hhuTfForm" onsubmit="return false;" class="ui-form">
	<div class="ui-tab">
