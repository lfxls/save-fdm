...
<script type="text/javascript" src="${ctx}/js/modules/sysModule/rzgl/hhuLog/hhuDuLog.js"></script>
</head>
<body class="body">
	<div class="ui-tab">
		<ul class="ui-tab-items">
			<li class="ui-tab-item">
				<a href="${ctx}/system/rzgl/hhuLog!init.do"><s:text name="sysModule.rzgl.hhuLog.hhuWoLog" /></a>
			</li>
			<li class="ui-tab-item ui-tab-item-current">
				<a href="#"><s:text name="sysModule.rzgl.hhuLog.hhuDuLog" /></a>
			</li>
		</ul>
	</div>
	<div class="hr10"></div>
	<form id="hhuDuLogForm" name="hhuDuLogForm" onsubmit="return false;" class="ui-form">
	<div class="ui-panel">
		<div class="ui-panel-header">
			<s:text name="sysModule.rzgl.hhuLog.hhuDuLog.title"/>
		</div>
				...
				<table class="fluid-grid">
					<tr>
						<td	width="12%" align="right">
							<label><s:text name="sysModule.rzgl.hhuLog.hhuDuLog.optId" /></label>
						</td>
						<td width="14%">
							<s:textfield id="optId" name="optId" onblur="checkLength(this,128)" cssClass="ui-input"/>
						</td>						
						<td width="12%" align="right">
							<label><s:text name="sysModule.rzgl.hhuLog.hhuDuLog.hhuId" /></label>
						</td>
						<td width="14%">
							<s:textfield id="hhuId" name="hhuId" onblur="checkLength(this,64)" cssClass="ui-input"/>
						</td>
						<td width="12%" align="right">
							<label><s:text name="sysModule.rzgl.hhuLog.hhuWoLog.uptRst" /></label>
						</td>
						<td width="14%">
							<s:select name="upt_rst" id="upt_rst" list="hhuRst"
								listKey="BM" listValue="MC" cssClass="ui-select" />	
						</td>
						<td width="16%" valign="middle" align="center" >
							<input type="button"
									onclick="query();"
									value="<s:text name='sysModule.rzgl.hhuLog.hhuDuLog.query'/>"
									class="ext_btn" />
						</td>
					</tr>
					<tr>
						<td width="12%" align="right">
							<label class="ui-label"><s:text name="sysModule.rzgl.hhuLog.hhuDuLog.op_date"></s:text></label>
						</td>
						<td width="20%">
							<div id="Date">
