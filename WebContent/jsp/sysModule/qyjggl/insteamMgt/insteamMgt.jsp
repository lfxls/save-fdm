...
<script type="text/javascript" src="${ctx}/js/modules/sysModule/qyjggl/insteamMgt/insteamMgt.js"></script>
</head>
<body>
<form id="insteamform" name="insteamform" onsubmit="return false;" class="ui-form">
	<div class="ui-panel">
