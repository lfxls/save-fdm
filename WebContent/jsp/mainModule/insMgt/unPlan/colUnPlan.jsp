...
<script type="text/javascript" src="${ctx}/js/modules/mainModule/insMgt/unPlan/colUnPlan.js"></script>
</head>
<body class="body">
	<div class="ui-tab">
		<ul class="ui-tab-items">
			<li class="ui-tab-item"><a 
				href="${ctx}/main/insMgt/insUnPlan!init.do"><s:text
						name="mainModule.insMgt.plan.meter" /></a>
			</li>
			<li class="ui-tab-item"><a href="${ctx}/main/insMgt/insUnPlan!initDcuUnP.do"><s:text
	...
	<form id="colUnPlanForm" name="colUnPlanForm" onsubmit="return false;" class="ui-form">
