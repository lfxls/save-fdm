...
<script type="text/javascript" src="${ctx}/js/modules/mainModule/insMgt/plan/dcuPlan.js"></script>
</head>
<body class="body">
	<div class="ui-tab">
	...
	<form id="dcuPlanForm" name="dcuPlanForm" onsubmit="return false;" class="ui-form">
	
		<div class="ui-panel">
			<div class="ui-panel-header">
				<s:text name="mainModule.insMgt.plan.dcu.title"/>
			</div>
				...
				<div class="ui-panel-item">
					<table class="fluid-grid">
						<tr>
							...
							<td width="25%">
								<s:select id="dcuM" name="dcuM"
									list="dcuMList" listKey="BM" listValue="MC"
									onchange="changeDcuM(this.value)" cssClass="ui-select" />
							</td>
