...
<html>
	<head>
		...
		<script type="text/javascript" src="${ctx}/js/modules/mainModule/insMgt/query/orderQuery.js"> </script>
	</head>
	<body class="body">	
	<form id="woQueryForm" name="woQueryForm" onsubmit="return false;" class="ui-form">
		<div class="ui-panel">
			<div class="ui-panel-header">
				<s:text name="mainModule.insMgt.order.detail.title"/>
			</div>	
			...
			<div class="ui-panel-body">
				<div class="ui-panel-item">
					<table class="fluid-grid">
						...
						<tr>
							<td align="right">
						   		<label><s:text name="mainModule.insMgt.order.type"/></label>
						   	</td>
						    <td>
						    	<s:select id="type" name="type" cssClass="ui-select"
									list="typeLs" listKey="BM" listValue="MC"
							...
							<td align="center">
								<input id="reset" type="button" onclick="woReset();" 
