...
<script type="text/javascript" src="${ctx}/js/modules/mainModule/insMgt/order/selDInsPlan.js"></script>
</head>
<body class="body">
	<form id="selDInsPForm" name="selDInsPForm" onsubmit="return false;" class="ui-form">
		<div class="ui-panel">
