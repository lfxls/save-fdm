...
<script type="text/javascript" src="${ctx}/js/modules/mainModule/insMgt/order/selCInsPlan.js"></script>
</head>
<body class="body">
	<form id="selCInsPForm" name="selCInsPForm" onsubmit="return false;" class="ui-form">
		<div class="ui-panel">
