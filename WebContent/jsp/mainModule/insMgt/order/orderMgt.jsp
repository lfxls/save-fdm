...
<html>
	<head>
		...
		<script type="text/javascript" src="${ctx}/js/modules/mainModule/insMgt/order/orderMgt.js"> </script>
	</head>
	<body class="body">	
	
	
	<form id="queryWOForm" name="queryWOForm" onsubmit="return false;" class="ui-form">
		<s:hidden id="helpDocAreaId" name="helpDocAreaId"/>
		<div class="ui-panel">
			<div class="ui-panel-header">
				<s:text name="mainModule.insMgt.order.title"/>
			</div>	
				...
				<div class="ui-panel-item">
					<table class="fluid-grid">
						...
						<tr>
						    ...
						    <td>
						    	<s:select id="oType" name="oType" cssClass="ui-select"
									list="oTList" listKey="BM" listValue="MC"
