...
<script type="text/javascript" src="${ctx}/js/modules/mainModule/insMgt/order/selMInsPlan.js"></script>
</head>
<body class="body">
	<form id="selMInsPForm" name="selMInsPForm" onsubmit="return false;" class="ui-form">
