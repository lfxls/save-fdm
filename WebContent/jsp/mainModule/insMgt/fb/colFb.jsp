...
<script type="text/javascript" src="${ctx}/js/modules/mainModule/insMgt/fb/colFb.js"></script>
</head>
<body class="body">
	<div class="ui-tab">
		<ul class="ui-tab-items">
			<li class="ui-tab-item">
				<a href="${ctx}/main/insMgt/insFb!init.do"><s:text
	...
	<form id="colFbForm" name="colFbForm" onsubmit="return false;" class="ui-form">
	
		<div class="ui-panel">
			<div class="ui-panel-header">
				<s:text name="mainModule.insMgt.fb.col.title"/>
			</div>
				...
				<div class="ui-panel-item">
					<table class="fluid-grid">
						<tr>
							...
							<td width="25%">
								<s:textfield id="tfName" name="tfName" onblur="checkLength(this,32)" cssClass="ui-input"/>
							</td>
