...
<script type="text/javascript" src="${ctx}/js/modules/mainModule/insMgt/fb/dcuFb.js"></script>
</head>
<body class="body">
	<div class="ui-tab">
	...
	<form id="dcuFbForm" name="dcuFbForm" onsubmit="return false;" class="ui-form">
	
		<div class="ui-panel">
			<div class="ui-panel-header">
				<s:text name="mainModule.insMgt.fb.dcu.title"/>
			</div>
