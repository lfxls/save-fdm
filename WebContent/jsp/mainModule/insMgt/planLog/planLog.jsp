...
<html>
	<head>
		...
		<script type="text/javascript" src="${ctx}/js/modules/mainModule/insMgt/planLog/planLog.js"> </script>
	</head>
	<body class="body">	
	<s:hidden id="pid" name="pid" />
	<%-- <form id="planLogForm" name="planLogForm" onsubmit="return false;" class="ui-form">
		<div class="ui-panel">
			<div class="ui-panel-header">
				<s:text name="mainModule.insMgt.planLog.title"/>
			</div>	
			...
			<div class="ui-panel-body">
				<div class="ui-panel-item">
					<table class="fluid-grid">
						...
						<tr>
							<td align="right">
								<label><s:text name="mainModule.insMgt.planLog.devType"/></label>
							</td>
							<td >
								<s:select id="devType" name="devType" cssClass="ui-select"
									list="devTypeLs" listKey="BM" listValue="MC"
									onchange="changeDevType(this.value)" />
							</td>
							<td align="right">
