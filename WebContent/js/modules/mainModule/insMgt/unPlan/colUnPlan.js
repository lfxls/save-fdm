var colUnPGrid = '';
var menuId = '12100';
var grid_url = ctx + '/main/insMgt/insUnPlan!queryCInsP.do';
Ext.onReady(function() {
	...
	var p = $FF('colUnPlanForm');
	
	//grid数据初始
	colUnPGrid.init(p);// （是否选择、是否单选）
});
...
function dispatch(){
	...
	var baseParam = {
		url : url,
		title : main.insMgt.unPlan.win.title.addDisp,
		el : 'addTfDisp',
		width : 760,
		height : 650,
		draggable : true
