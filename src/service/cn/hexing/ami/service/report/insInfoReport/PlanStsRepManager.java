...
public class PlanStsRepManager implements PlanStsRepManagerInf{
	private BaseDAOIbatis baseDAOIbatis;
	private String sqlId="planStsRep.";
	...
	public Map<String, Object> query(Map<String, Object> param, String start,
		...
		return baseDAOIbatis.getExtGrid(param, sqlId+"getPlanSts", start, limit, dir, sort, isExcel);
	}
	...
	public String getChart(Map<String, String> params) {
		...
		String caption=I18nUtil.getText("report.insInfoReport.planStsRep.chart.title", params.get("appLang"));
