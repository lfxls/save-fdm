package cn.hexing.ami.util.aes;
...
public class RijndaelUtil {
	private static Logger logger = Logger.getLogger(RijndaelUtil.class.getName());
	private static final int DEFAULT_BLOCK_SIZE = 16;
	private static final String key = "ami@hxgroup.cn";
	 ...
	 */
	public static String encodePassword(String mm) {
		if (mm == "" || mm == null) {
			return mm;
		} else {
			String strKey = key;
			...
			String jmmm = null;
			try {
				jmmm = encode(strKey, mm, blockSize);
	 ...
	 * @throws Exception
	 */
	public static String decodePassword(String mm) throws Exception {
		if (mm == "" || mm == null) {
			return mm;
		} else {
			String strKey = key;
